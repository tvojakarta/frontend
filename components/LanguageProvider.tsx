...
const translations: Record<Language, Record<string, string>> = {
  sr: {
    ...
    'footer.description': 'Vaš pouzdani partner za karte za sve događaje u Banja Luci i Prijedoru.',
  ...
  en: {
    ...
    // Footer
    'footer.company': 'Tvoja Karta',
    'footer.description': 'Your trusted partner for tickets to all events in Banja Luka and Prijedor.',
